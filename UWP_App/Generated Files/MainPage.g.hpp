...
void ::UWP_App::MainPage::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
void ::UWP_App::MainPage::Connect(int __connectionId, ::Platform::Object^ __target)
{
    ...
    case 6:
        {
            ...
            (safe_cast<::Windows::UI::Xaml::Controls::Button^>(this->inputButton))->Click += ref new ::Windows::UI::Xaml::RoutedEventHandler(this, (void (::UWP_App::MainPage::*)
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::UWP_App::MainPage::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
