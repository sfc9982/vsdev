...
std::string sliceName(const std::string &);
...
std::string sliceName(const std::string &name) {
    UErrorCode               status = U_ZERO_ERROR;
    const icu::UnicodeString ucs    = icu::UnicodeString::fromUTF8(icu::StringPiece(name.c_str()));
