...
namespace mino2357 {
    ...
    constexpr ButcherRKF45<T>::ButcherRKF45() {
        ...
        table[2][0] = ratio<T>(3, 32);
        table[2][1] = ratio<T>(9, 32);
        table[3][0] = ratio<T>(1932, 2197);
        table[3][1] = -ratio<T>(7200, 2197);
        table[3][2] = ratio<T>(7296, 2197);
        table[4][0] = ratio<T>(439, 216);
        table[4][1] = -ratio<T>(8, 1);
        table[4][2] = ratio<T>(3680, 513);
        table[4][3] = -ratio<T>(845, 4104);
        table[5][0] = -ratio<T>(8, 27);
        table[5][1] = ratio<T>(2, 1);
        table[5][2] = -ratio<T>(3544, 2565);
        table[5][3] = ratio<T>(1859, 4104);
        table[5][4] = -ratio<T>(11, 40);

        order6[0] = ratio<T>(16, 135);
        order6[1] = ratio<T>(0, 1);
        order6[2] = ratio<T>(6656, 12825);
        order6[3] = ratio<T>(28561, 56430);
        order6[4] = -ratio<T>(9, 50);
        order6[5] = ratio<T>(2, 55);

        order5[0] = ratio<T>(25, 216);
        order5[1] = ratio<T>(0, 1);
        order5[2] = ratio<T>(1408, 2565);
        order5[3] = ratio<T>(2197, 4104);
        order5[4] = -ratio<T>(1, 5);
        order5[5] = ratio<T>(0, 1);

        minus[0] = ratio<T>(1, 360);
        minus[1] = ratio<T>(0, 1);
        minus[2] = -ratio<T>(128, 4275);
        minus[3] = -ratio<T>(2197, 75240);
        minus[4] = ratio<T>(1, 50);
        minus[5] = ratio<T>(2, 55);
    }
    ...
    inline constexpr void RKF78<T>::Integrate(T &t, T &dt, mino2357::vector<T> &x) noexcept {
        ...
        k6  = func<T>(x + crt_h * f(6, 0) * k0 + crt_h * f(6, 1) * k1 + crt_h * f(6, 2) * k2 + crt_h * f(6, 3) * k3 + crt_h * f(6, 4) * k4 + crt_h * f(6, 5) * k5);
        k7  = func<T>(x + crt_h * f(7, 0) * k0 + crt_h * f(7, 1) * k1 + crt_h * f(7, 2) * k2 + crt_h * f(7, 3) * k3 + crt_h * f(7, 4) * k4 + crt_h * f(7, 5) * k5 + crt_h * f(7, 6) * k6);
        k8  = func<T>(x + crt_h * f(8, 0) * k0 + crt_h * f(8, 1) * k1 + crt_h * f(8, 2) * k2 + crt_h * f(8, 3) * k3 + crt_h * f(8, 4) * k4 + crt_h * f(8, 5) * k5 + crt_h * f(8, 6) * k6 + crt_h * f(8, 7) * k7);
        k9  = func<T>(x + crt_h * f(9, 0) * k0 + crt_h * f(9, 1) * k1 + crt_h * f(9, 2) * k2 + crt_h * f(9, 3) * k3 + crt_h * f(9, 4) * k4 + crt_h * f(9, 5) * k5 + crt_h * f(9, 6) * k6 + crt_h * f(9, 7) * k7 + crt_h * f(9, 8) * k8);
        k10 = func<T>(x + crt_h * f(10, 0) * k0 + crt_h * f(10, 1) * k1 + crt_h * f(10, 2) * k2 + crt_h * f(10, 3) * k3 + crt_h * f(10, 4) * k4 + crt_h * f(10, 5) * k5 + crt_h * f(10, 6) * k6 + crt_h * f(10, 7) * k7 + crt_h * f(10, 8) * k8 + crt_h * f(10, 9) * k9);
        k11 = func<T>(x + crt_h * f(11, 0) * k0 + crt_h * f(11, 1) * k1 + crt_h * f(11, 2) * k2 + crt_h * f(11, 3) * k3 + crt_h * f(11, 4) * k4 + crt_h * f(11, 5) * k5 + crt_h * f(11, 6) * k6 + crt_h * f(11, 7) * k7 + crt_h * f(11, 8) * k8 + crt_h * f(11, 9) * k9 + crt_h * f(11, 10) * k10);
        k12 = func<T>(x + crt_h * f(12, 0) * k0 + crt_h * f(12, 1) * k1 + crt_h * f(12, 2) * k2 + crt_h * f(12, 3) * k3 + crt_h * f(12, 4) * k4 + crt_h * f(12, 5) * k5 + crt_h * f(12, 6) * k6 + crt_h * f(12, 7) * k7 + crt_h * f(12, 8) * k8 + crt_h * f(12, 9) * k9 + crt_h * f(12, 10) * k10 + crt_h * f(12, 11) * k11);

        x8 = x + crt_h * (f.o8(0) * k0 + f.o8(1) * k1 + f.o8(2) * k2 + f.o8(3) * k3 + f.o8(4) * k4 + f.o8(5) * k5 + f.o8(6) * k6 + f.o8(7) * k7 + f.o8(8) * k8 + f.o8(9) * k9 + f.o8(10) * k10 + f.o8(11) * k11 + f.o8(12) * k12);

        x9 = x + crt_h * (f.o9(0) * k0 + f.o9(1) * k1 + f.o9(2) * k2 + f.o9(3) * k3 + f.o9(4) * k4 + f.o9(5) * k5 + f.o9(6) * k6 + f.o9(7) * k7 + f.o9(8) * k8 + f.o9(9) * k9 + f.o9(10) * k10 + f.o9(11) * k11 + f.o9(12) * k12);
